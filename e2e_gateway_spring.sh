...
NILCHAIND_BIN="./polystorechain/polystorechaind"
...
OWNER_ADDR=$(timeout 10s $NILCHAIND_BIN keys show faucet -a --home _artifacts/polystorechain_data --keyring-backend test | tail -n 1)
...
DEALS_JSON=$($NILCHAIND_BIN query polystorechain list-deals -o json)
...
$NILCHAIND_BIN tx polystorechain update-deal-content --help
...
FINAL_DEAL=$($NILCHAIND_BIN query polystorechain get-deal --id $DEAL_ID -o json)
