...
Observed result: retrieval success was `100.00%`, reward coverage was `99.74%`, repairs started/ready/completed were `6` / `6` / `6`, and `1` providers ended with negative modeled P&L. The run recorded `0` unavailable reads, `0` modeled data-loss events, `0` bandwidth saturation responses and `0` repair backoffs.
...
| 3 | `repair_ready` | 1 | 0 | `sp-000` | `sp-045` | `catchup_ready` |
| 3 | `repair_completed` | 1 | 0 | `sp-000` | `sp-045` | `catchup_complete` |
| 3 | `repair_ready` | 5 | 0 | `sp-000` | `sp-037` | `catchup_ready` |
| 3 | `repair_completed` | 5 | 0 | `sp-000` | `sp-037` | `catchup_complete` |
| 3 | `repair_ready` | 9 | 0 | `sp-000` | `sp-022` | `catchup_ready` |
