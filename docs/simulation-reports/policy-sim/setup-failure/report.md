...
Observed result: retrieval success was `100.00%`, reward coverage was `99.74%`, repairs started/completed were `6` / `6`, and `1` providers ended with negative modeled P&L. The run recorded `0` unavailable reads, `0` modeled data-loss events, `0` bandwidth saturation responses and `0` repair backoffs.
...
|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 100.00% | 27 | 6 | 0 | 0.1200 | 5.8000 | 15 offline responses, 6 quota misses |
...
|---:|---|---:|---:|---|---|---|
| 1 | `repair_started` | 1 | 0 | `sp-000` | `sp-045` | `deputy_served_zero_direct` |
| 1 | `repair_started` | 5 | 0 | `sp-000` | `sp-037` | `deputy_served_zero_direct` |
| 1 | `repair_started` | 9 | 0 | `sp-000` | `sp-022` | `deputy_served_zero_direct` |
| 1 | `repair_started` | 13 | 0 | `sp-000` | `sp-032` | `deputy_served_zero_direct` |
| 1 | `repair_started` | 17 | 0 | `sp-000` | `sp-041` | `deputy_served_zero_direct` |
| 1 | `repair_started` | 21 | 0 | `sp-000` | `sp-014` | `deputy_served_zero_direct` |
| 3 | `repair_completed` | 1 | 0 | `sp-000` | `sp-045` | `catchup_complete` |
| 3 | `repair_completed` | 5 | 0 | `sp-000` | `sp-037` | `catchup_complete` |
| 3 | `repair_completed` | 9 | 0 | `sp-000` | `sp-022` | `catchup_complete` |
| 3 | `repair_completed` | 13 | 0 | `sp-000` | `sp-032` | `catchup_complete` |
| 3 | `repair_completed` | 17 | 0 | `sp-000` | `sp-041` | `catchup_complete` |
| 3 | `repair_completed` | 21 | 0 | `sp-000` | `sp-014` | `catchup_complete` |
