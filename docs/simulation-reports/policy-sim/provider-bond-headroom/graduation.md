# Graduation Assessment: Provider Bond Headroom
...
Graduation means minimum bond and per-slot collateral constraints are explicit enough to exclude or repair undercollateralized providers before keeper bond state is implemented.
