...
| Audit demand / spent | `0.2300` / `0.2300` | Shows whether enforcement evidence consumed the available audit budget. |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `op-000` | 1 | 2.08% | 6 | 2.08% | 129 | 65.89% | 0.3425 |
| `op-001` | 1 | 2.08% | 6 | 2.08% | 117 | 100.00% | 1.0945 |
| `op-002` | 1 | 2.08% | 6 | 2.08% | 126 | 100.00% | 1.1710 |
| `op-003` | 1 | 2.08% | 6 | 2.08% | 127 | 100.00% | 1.1795 |
| `op-004` | 1 | 2.08% | 6 | 2.08% | 114 | 100.00% | 1.0690 |
| `op-005` | 1 | 2.08% | 6 | 2.08% | 116 | 100.00% | 1.0860 |
| `op-006` | 1 | 2.08% | 6 | 2.08% | 129 | 100.00% | 1.1965 |
| `op-007` | 1 | 2.08% | 6 | 2.08% | 124 | 100.00% | 1.1540 |
...
Audit accounting saw `0.2300` of demand, spent `0.2300`, and ended with `0.0000` backlog after `0` exhausted epochs.
