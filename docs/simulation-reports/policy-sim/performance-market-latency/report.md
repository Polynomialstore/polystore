...
| Owner-funded attempts / owner escrow debit | `6240` / `0.0000` | Detects whether public demand is unexpectedly draining the deal owner's escrow. |
| Wash accounted spend / net gain | `18.7200` / `645.2160` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
| Retrieval latent/effective attempts | `6240` / `6240` | Shows how much retrieval load was added by demand-shock multipliers. |
...
Wash-retrieval accounting shows explicit spend `18.7200` against possible colluding-provider gain `645.2160`.
