...
|---|---:|---:|---:|---:|---:|---:|---:|
| `op-017` | 1 | 2.08% | 7 | 2.43% | 152 | 100.00% | 1.4420 |
| `op-025` | 1 | 2.08% | 7 | 2.43% | 150 | 100.00% | 1.4250 |
| `op-026` | 1 | 2.08% | 7 | 2.43% | 145 | 100.00% | 1.3825 |
| `op-033` | 1 | 2.08% | 7 | 2.43% | 150 | 100.00% | 1.4250 |
| `op-039` | 1 | 2.08% | 7 | 2.43% | 164 | 100.00% | 1.5440 |
| `op-045` | 1 | 2.08% | 7 | 2.43% | 156 | 100.00% | 1.4760 |
| `op-001` | 1 | 2.08% | 6 | 2.08% | 146 | 100.00% | 1.3410 |
| `op-002` | 1 | 2.08% | 6 | 2.08% | 135 | 100.00% | 1.2475 |
...
The simulator recorded `12` evidence events and `18` repair ledger events. The first evidence epoch was `2` and the first repair-start epoch was `2`.
...
|---:|---|---:|---:|---|---|---|---:|---:|
| 2 | `repair_started` | 1 | 0 | `sp-000` | `sp-017` | `deputy_served_zero_direct` | 1 | 0 |
| 2 | `repair_started` | 5 | 0 | `sp-000` | `sp-033` | `deputy_served_zero_direct` | 1 | 0 |
| 2 | `repair_started` | 9 | 0 | `sp-000` | `sp-026` | `deputy_served_zero_direct` | 1 | 0 |
| 2 | `repair_started` | 13 | 0 | `sp-000` | `sp-045` | `deputy_served_zero_direct` | 1 | 0 |
| 2 | `repair_started` | 17 | 0 | `sp-000` | `sp-025` | `deputy_served_zero_direct` | 1 | 0 |
| 2 | `repair_started` | 21 | 0 | `sp-000` | `sp-039` | `deputy_served_zero_direct` | 1 | 0 |
| 4 | `repair_ready` | 1 | 0 | `sp-000` | `sp-017` | `catchup_ready` | 1 | 0 |
| 4 | `repair_completed` | 1 | 0 | `sp-000` | `sp-017` | `catchup_complete` | 1 | 0 |
| 4 | `repair_ready` | 5 | 0 | `sp-000` | `sp-033` | `catchup_ready` | 1 | 0 |
| 4 | `repair_completed` | 5 | 0 | `sp-000` | `sp-033` | `catchup_complete` | 1 | 0 |
| 4 | `repair_ready` | 9 | 0 | `sp-000` | `sp-026` | `catchup_ready` | 1 | 0 |
| 4 | `repair_completed` | 9 | 0 | `sp-000` | `sp-026` | `catchup_complete` | 1 | 0 |
