# Risk Register: Price Controller Bounds
...
- Wash retrieval accounted spend/net gain: `22.4000` / `2039.6559`
...
- Final open/closed/expired deals: `96` / `0` / `0`
- Data-loss events: `0`
...
- Final active/exited/reserve provider capacity: `1327` / `0` / `0`
