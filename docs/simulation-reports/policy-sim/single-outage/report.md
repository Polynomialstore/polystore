...
Observed result: retrieval success was `100.00%`, reward coverage was `99.76%`, repairs started/completed were `6` / `6`, and `1` providers ended with negative modeled P&L. The run recorded `0` unavailable reads, `0` modeled data-loss events, `0` bandwidth saturation responses and `0` repair backoffs.
...
| 2 | 100.00% | 23 | 5 | 0 | 0.1200 | 11.7200 | 12 offline responses, 6 quota misses |
| 3 | 100.00% | 4 | 1 | 0 | 0.0200 | 17.5200 | 2 offline responses, 1 quota misses, 5 slots repairing |
| 4 | 100.00% | 0 | 0 | 5 | 0.0000 | 23.3200 | 6 slots repairing |
| 5 | 100.00% | 0 | 0 | 1 | 0.0000 | 29.2200 | 1 slots repairing |
| 6 | 100.00% | 0 | 0 | 0 | 0.0000 | 35.1400 | steady state |
| 7 | 100.00% | 0 | 0 | 0 | 0.0000 | 41.0600 | steady state |
| 8 | 100.00% | 0 | 0 | 0 | 0.0000 | 46.9800 | steady state |
| 9 | 100.00% | 0 | 0 | 0 | 0.0000 | 52.9000 | steady state |
| 10 | 100.00% | 0 | 0 | 0 | 0.0000 | 58.8200 | steady state |

## Enforcement Interpretation

The simulator recorded `13` evidence events and `12` repair ledger events. The first evidence epoch was `2` and the first repair-start epoch was `2`.
...
|---:|---|---:|---:|---|---|---|
| 2 | `repair_started` | 1 | 0 | `sp-000` | `sp-022` | `deputy_served_zero_direct` |
| 2 | `repair_started` | 5 | 0 | `sp-000` | `sp-025` | `deputy_served_zero_direct` |
| 2 | `repair_started` | 9 | 0 | `sp-000` | `sp-041` | `deputy_served_zero_direct` |
| 2 | `repair_started` | 17 | 0 | `sp-000` | `sp-014` | `deputy_served_zero_direct` |
| 2 | `repair_started` | 21 | 0 | `sp-000` | `sp-038` | `deputy_served_zero_direct` |
| 3 | `repair_started` | 13 | 0 | `sp-000` | `sp-047` | `deputy_served_zero_direct` |
...
| 5 | `repair_completed` | 13 | 0 | `sp-000` | `sp-047` | `catchup_complete` |
