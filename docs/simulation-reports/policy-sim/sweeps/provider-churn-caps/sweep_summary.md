...
|---|---|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `baseline-churn-base-repair` | `provider-economic-churn` | `91` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 48/48 | 0 | 0 | 8 | 1.3121 | 0.0131 |
| `burst-churn-constrained-repair` | `provider-economic-churn` | `91` | `high` | `PASS` | 98.08% | 23 | 0 | 0 | 0 | 48/48 | 48 | 0 | 8 | 1.3121 | 0.0131 |
| `burst-churn-wide-repair` | `provider-economic-churn` | `91` | `high` | `PASS` | 98.75% | 15 | 0 | 0 | 0 | 48/48 | 16 | 0 | 8 | 1.3121 | 0.0131 |
| `fast-churn-constrained-repair` | `provider-economic-churn` | `91` | `high` | `PASS` | 97.58% | 29 | 0 | 0 | 0 | 40/40 | 112 | 0 | 8 | 1.3121 | 0.0131 |
| `fast-churn-wide-repair` | `provider-economic-churn` | `91` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 48/48 | 0 | 0 | 8 | 1.3121 | 0.0131 |
| `slow-churn-base-repair` | `provider-economic-churn` | `91` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 42/35 | 0 | 0 | 8 | 1.3121 | 0.0131 |
| `slow-churn-constrained-repair` | `provider-economic-churn` | `91` | `medium` | `PASS` | 99.67% | 4 | 0 | 0 | 0 | 28/24 | 56 | 0 | 8 | 1.3121 | 0.0131 |
...
| `offline_responses` | 82.000000 | 477.000000 | 395.000000 | 199.142857 | Provider responses missed because a selected provider was offline. |
...
| `repairs_ready` | 24.000000 | 48.000000 | 24.000000 | 41.571429 | Pending replacement providers that proved readiness. |
...
| `retrieval_base_burned` | 1.200000 | 1.200000 | 0.000000 | 1.200000 | Base retrieval fees burned across live retrieval attempts. |
| `retrieval_variable_burned` | 5.380655 | 5.518221 | 0.137566 | 5.470684 | Variable retrieval fee burn withheld from provider payout. |
| `retrieval_provider_payouts` | 102.232452 | 104.846203 | 2.613750 | 103.942997 | Retrieval fees paid to providers for served slots. |
...
| `retrieval_wash_accounted_spend` | 1.200000 | 1.200000 | 0.000000 | 1.200000 | Explicit modeled requester, sponsor, or owner-funded retrieval spend counted against wash traffic. |
| `retrieval_wash_net_gain` | 101.032452 | 103.646203 | 2.613750 | 102.742997 | Worst-case colluding requester/provider net gain; positive values indicate wash abuse risk. |
| `retrieval_attempts` | 1200.000000 | 1200.000000 | 0.000000 | 1200.000000 | Effective retrieval attempts after demand shock multipliers and inactive-content rejection. |
...
| `deputy_misses` | 24.000000 | 78.000000 | 54.000000 | 44.000000 | Deputy-served slots where the responsible provider failed direct service. |
...
| `max_storage_price` | 1.312087 | 1.312087 | 0.000000 | 1.312087 | Highest storage price observed during the run. |
...
| `max_retrieval_price` | 0.013121 | 0.013121 | 0.000000 | 0.013121 | Highest retrieval price observed during the run. |
