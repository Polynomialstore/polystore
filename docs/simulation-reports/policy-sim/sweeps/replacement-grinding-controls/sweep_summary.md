...
|---|---|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `baseline-cap3-timeout1-backoff2` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 18/0 | 24 | 0 | 1 | 1.0000 | 0.0100 |
| `cap1-timeout1-backoff2` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 6/0 | 48 | 0 | 1 | 1.0000 | 0.0100 |
| `cap2-timeout1-backoff2` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 12/0 | 36 | 0 | 1 | 1.0000 | 0.0100 |
| `cap3-timeout1-backoff4` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 12/0 | 36 | 0 | 1 | 1.0000 | 0.0100 |
| `cap3-timeout1-no-backoff` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 18/0 | 24 | 0 | 1 | 1.0000 | 0.0100 |
| `cap3-timeout2-backoff2` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 18/0 | 12 | 0 | 1 | 1.0000 | 0.0100 |
| `no-cap-timeout1-backoff2` | `replacement-grinding` | `41` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 24/0 | 18 | 0 | 1 | 1.0000 | 0.0100 |
...
| `offline_responses` | 88.000000 | 156.000000 | 68.000000 | 120.142857 | Provider responses missed because a selected provider was offline. |
...
| `reward_coverage` | 0.974930 | 0.985915 | 0.010985 | 0.979619 | Shows whether compliant responsibility remains economically recognized. |
| `reward_pool_minted` | 42.600000 | 43.080000 | 0.480000 | 42.874286 | Modeled base subsidy made available to active slots. |
| `reward_paid` | 42.000000 | 42.000000 | 0.000000 | 42.000000 | Base subsidy actually paid to reward-eligible slots. |
| `reward_burned` | 0.600000 | 1.080000 | 0.480000 | 0.874286 | Base subsidy withheld from non-compliant responsibility. |
| `repairs_started` | 6.000000 | 24.000000 | 18.000000 | 15.428571 | Detection and repair activation pressure. |
...
| `repair_attempts` | 6.000000 | 24.000000 | 18.000000 | 15.428571 | Repair retry pressure before starts or backoffs. |
| `repair_backoffs` | 12.000000 | 48.000000 | 36.000000 | 28.285714 | Replacement capacity or repair-start bottlenecks. |
| `repair_cooldowns` | 0.000000 | 36.000000 | 36.000000 | 18.857143 | Retry cooldowns that intentionally throttle repair churn. |
| `repair_attempt_caps` | 0.000000 | 24.000000 | 24.000000 | 9.428571 | Per-slot attempt caps hit before a replacement could start. |
| `repair_timeouts` | 6.000000 | 18.000000 | 12.000000 | 13.714286 | Pending replacement providers that failed readiness before timeout. |
...
| `max_operator_assignment_share_bps` | 360.000000 | 360.000000 | 0.000000 | 360.000000 | Worst observed assignment share of any operator across epochs. |
| `top_operator_assignment_share_bps` | 277.000000 | 360.000000 | 83.000000 | 300.714286 | Final assignment share of the largest operator. |
...
| `final_open_deals` | 18.000000 | 18.000000 | 0.000000 | 18.000000 | Deals still active at run end. |
...
| `delinquent_slots` | 60.000000 | 60.000000 | 0.000000 | 60.000000 | Threshold-crossed slot-epochs that should be visible to operators. |
...
| `deputy_misses` | 28.000000 | 51.000000 | 23.000000 | 40.714286 | Deputy-served slots where the responsible provider failed direct service. |
| `quota_misses` | 30.000000 | 54.000000 | 24.000000 | 43.714286 | Soft liveness evidence generated by the run. |
...
| `audit_budget_demand` | 0.290000 | 0.525000 | 0.235000 | 0.422143 | Total audit work implied by soft-failure evidence and carried backlog. |
| `audit_budget_spent` | 0.290000 | 0.525000 | 0.235000 | 0.422143 | Audit budget actually consumed under the configured cap. |
...
| `final_storage_utilization_bps` | 3645.000000 | 3750.000000 | 105.000000 | 3720.000000 | Supply utilization against modeled capacity. |
...
| `provider_pnl` | 56.800000 | 56.800000 | 0.000000 | 56.800000 | Aggregate provider economics; inspect distribution before deciding. |

## Varied Parameters

| Parameter | Values |
|---|---|
| `repair_attempt_cap_per_slot` | `0`, `1`, `2`, `3` |
| `repair_backoff_epochs` | `0`, `2`, `4` |
| `repair_pending_timeout_epochs` | `1`, `2` |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| `repair_attempt_cap_per_slot` | `0` | 1 | 100.00% | 0 | 0 | 18 | 1 | 1.0000 |
| `repair_attempt_cap_per_slot` | `1` | 1 | 100.00% | 0 | 0 | 48 | 1 | 1.0000 |
| `repair_attempt_cap_per_slot` | `2` | 1 | 100.00% | 0 | 0 | 36 | 1 | 1.0000 |
| `repair_attempt_cap_per_slot` | `3` | 4 | 100.00% | 0 | 0 | 24 | 1 | 1.0000 |
| `repair_backoff_epochs` | `0` | 1 | 100.00% | 0 | 0 | 24 | 1 | 1.0000 |
| `repair_backoff_epochs` | `2` | 5 | 100.00% | 0 | 0 | 27.6000 | 1 | 1.0000 |
| `repair_backoff_epochs` | `4` | 1 | 100.00% | 0 | 0 | 36 | 1 | 1.0000 |
| `repair_pending_timeout_epochs` | `1` | 6 | 100.00% | 0 | 0 | 31 | 1 | 1.0000 |
| `repair_pending_timeout_epochs` | `2` | 1 | 100.00% | 0 | 0 | 12 | 1 | 1.0000 |

## High-Risk Runs

| Run | Scenario | Risk | Reasons |
|---|---|---|---|
| `no-cap-timeout1-backoff2` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `cap3-timeout2-backoff2` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `cap3-timeout1-no-backoff` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `cap3-timeout1-backoff4` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `cap2-timeout1-backoff2` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `cap1-timeout1-backoff2` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |
| `baseline-cap3-timeout1-backoff2` | `replacement-grinding` | `medium` | repair coordination backoffs occurred; pending repair readiness timeouts occurred; some providers ended with negative modeled P&L |

## Best Observed Run

`cap3-timeout2-backoff2` is the best observed run under the current ordering: zero data loss first, then highest retrieval success, then fewer unavailable reads, capacity violations, negative-P&L providers, and repair backoffs.
