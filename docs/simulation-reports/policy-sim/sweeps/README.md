...
| `provider-bond-headroom-controls` | 7 | 0 | Sensitivity sweep for provider minimum bond, per-slot collateral, initial bond, and bps-based hard-fault slash sizing. | [summary](provider-bond-headroom-controls/sweep_summary.md) |
