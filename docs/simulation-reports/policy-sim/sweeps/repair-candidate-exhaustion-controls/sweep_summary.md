...
- Decision posture: inspect critical runs before selecting a parameter baseline.
...
|---|---|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `attempt-cap2` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
| `backoff4` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
| `baseline-cap8-attempt1-backoff2` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
| `extra-capacity-cap10` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 8/8 | 0 | 0 | 1 | 1.0000 | 0.0100 |
| `no-attempt-cap` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
| `no-backoff` | `repair-candidate-exhaustion` | `37` | `medium` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
| `unsafe-low-capacity-cap6` | `repair-candidate-exhaustion` | `37` | `critical` | `PASS` | 100.00% | 0 | 0 | 0 | 0 | 0/0 | 40 | 0 | 0 | 1.0000 | 0.0100 |
...
| `offline_responses` | 61.000000 | 280.000000 | 219.000000 | 248.714286 | Provider responses missed because a selected provider was offline. |
...
| `reward_coverage` | 0.947917 | 0.989362 | 0.041445 | 0.953837 | Shows whether compliant responsibility remains economically recognized. |
| `reward_pool_minted` | 15.040000 | 15.360000 | 0.320000 | 15.314286 | Modeled base subsidy made available to active slots. |
| `reward_paid` | 14.560000 | 14.880000 | 0.320000 | 14.605714 | Base subsidy actually paid to reward-eligible slots. |
| `reward_burned` | 0.160000 | 0.800000 | 0.640000 | 0.708571 | Base subsidy withheld from non-compliant responsibility. |
| `repairs_started` | 0.000000 | 8.000000 | 8.000000 | 1.142857 | Detection and repair activation pressure. |
| `repairs_ready` | 0.000000 | 8.000000 | 8.000000 | 1.142857 | Pending replacement providers that proved readiness. |
| `repairs_completed` | 0.000000 | 8.000000 | 8.000000 | 1.142857 | Healing throughput under the parameter set. |
| `repair_attempts` | 8.000000 | 24.000000 | 16.000000 | 11.428571 | Repair retry pressure before starts or backoffs. |
| `repair_backoffs` | 0.000000 | 40.000000 | 40.000000 | 34.285714 | Replacement capacity or repair-start bottlenecks. |
| `repair_cooldowns` | 0.000000 | 24.000000 | 24.000000 | 12.571429 | Retry cooldowns that intentionally throttle repair churn. |
| `repair_attempt_caps` | 0.000000 | 32.000000 | 32.000000 | 11.428571 | Per-slot attempt caps hit before a replacement could start. |
...
| `max_operator_assignment_share_bps` | 833.000000 | 1041.000000 | 208.000000 | 862.714286 | Worst observed assignment share of any operator across epochs. |
| `top_operator_assignment_share_bps` | 833.000000 | 1041.000000 | 208.000000 | 862.714286 | Final assignment share of the largest operator. |
| `top_operator_provider_share_bps` | 833.000000 | 833.000000 | 0.000000 | 833.000000 | Provider identity share controlled by the largest operator. |
| `max_operator_deal_slots` | 1.000000 | 2.000000 | 1.000000 | 1.142857 | Maximum same-operator slots in any one deal. |
...
| `final_open_deals` | 8.000000 | 8.000000 | 0.000000 | 8.000000 | Deals still active at run end. |
...
| `retrieval_variable_burned` | 2.560000 | 2.560000 | 0.000000 | 2.560000 | Variable retrieval fee burn withheld from provider payout. |
| `retrieval_provider_payouts` | 48.640000 | 48.640000 | 0.000000 | 48.640000 | Retrieval fees paid to providers for served slots. |
...
| `retrieval_wash_net_gain` | 48.000000 | 48.000000 | 0.000000 | 48.000000 | Worst-case colluding requester/provider net gain; positive values indicate wash abuse risk. |
...
| `delinquent_slots` | 16.000000 | 40.000000 | 24.000000 | 36.571429 | Threshold-crossed slot-epochs that should be visible to operators. |
...
| `deputy_misses` | 8.000000 | 40.000000 | 32.000000 | 35.428571 | Deputy-served slots where the responsible provider failed direct service. |
| `quota_misses` | 8.000000 | 40.000000 | 32.000000 | 35.428571 | Soft liveness evidence generated by the run. |
...
| `audit_budget_demand` | 0.080000 | 0.400000 | 0.320000 | 0.354286 | Total audit work implied by soft-failure evidence and carried backlog. |
| `audit_budget_spent` | 0.080000 | 0.400000 | 0.320000 | 0.354286 | Audit budget actually consumed under the configured cap. |
...
| `churn_pressure_provider_epochs` | 1.000000 | 2.000000 | 1.000000 | 1.857143 | Provider-epochs below the churn threshold. |
| `max_churn_pressure_providers` | 1.000000 | 1.000000 | 0.000000 | 1.000000 | Peak providers simultaneously eligible for churn. |
| `final_active_provider_capacity` | 72.000000 | 120.000000 | 48.000000 | 96.000000 | Provider capacity remaining after economic exits. |
...
| `providers_negative_pnl` | 0.000000 | 1.000000 | 1.000000 | 0.142857 | Market sustainability and churn pressure. |
| `saturated_responses` | 0.000000 | 0.000000 | 0.000000 | 0.000000 | Provider bandwidth bottleneck signal. |
| `providers_over_capacity` | 0.000000 | 12.000000 | 12.000000 | 1.714286 | Placement/capacity invariant; should remain zero. |
| `final_storage_utilization_bps` | 8000.000000 | 13333.000000 | 5333.000000 | 10190.428571 | Supply utilization against modeled capacity. |
...
| `provider_pnl` | 45.600000 | 45.920000 | 0.320000 | 45.645714 | Aggregate provider economics; inspect distribution before deciding. |

## Varied Parameters

| Parameter | Values |
|---|---|
| `provider_capacity_max` | `10`, `6`, `8` |
| `provider_capacity_min` | `10`, `6`, `8` |
| `repair_attempt_cap_per_slot` | `0`, `1`, `2` |
| `repair_backoff_epochs` | `0`, `2`, `4` |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| `provider_capacity_max` | `10` | 1 | 100.00% | 0 | 0 | 0 | 1 | 1.0000 |
| `provider_capacity_max` | `6` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `provider_capacity_max` | `8` | 5 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `provider_capacity_min` | `10` | 1 | 100.00% | 0 | 0 | 0 | 1 | 1.0000 |
| `provider_capacity_min` | `6` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `provider_capacity_min` | `8` | 5 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `repair_attempt_cap_per_slot` | `0` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `repair_attempt_cap_per_slot` | `1` | 5 | 100.00% | 0 | 0 | 32 | 0.2000 | 1.0000 |
| `repair_attempt_cap_per_slot` | `2` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `repair_backoff_epochs` | `0` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |
| `repair_backoff_epochs` | `2` | 5 | 100.00% | 0 | 0 | 32 | 0.2000 | 1.0000 |
| `repair_backoff_epochs` | `4` | 1 | 100.00% | 0 | 0 | 40 | 0 | 1.0000 |

## High-Risk Runs

| Run | Scenario | Risk | Reasons |
|---|---|---|---|
| `unsafe-low-capacity-cap6` | `repair-candidate-exhaustion` | `critical` | providers were assigned above modeled capacity; repair coordination backoffs occurred |
| `no-backoff` | `repair-candidate-exhaustion` | `medium` | repair coordination backoffs occurred |
| `no-attempt-cap` | `repair-candidate-exhaustion` | `medium` | repair coordination backoffs occurred |
| `extra-capacity-cap10` | `repair-candidate-exhaustion` | `medium` | some providers ended with negative modeled P&L |
| `baseline-cap8-attempt1-backoff2` | `repair-candidate-exhaustion` | `medium` | repair coordination backoffs occurred |
| `backoff4` | `repair-candidate-exhaustion` | `medium` | repair coordination backoffs occurred |
| `attempt-cap2` | `repair-candidate-exhaustion` | `medium` | repair coordination backoffs occurred |

## Best Observed Run

`attempt-cap2` is the best observed run under the current ordering: zero data loss first, then highest retrieval success, then fewer unavailable reads, capacity violations, negative-P&L providers, and repair backoffs.
