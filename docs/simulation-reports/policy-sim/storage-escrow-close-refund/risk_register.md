# Risk Register: Storage Escrow Close And Refund
...
|---|---|---|---|---|
| Evidence without repair | `high` | 16 evidence events and 0 repair events. | The simulator may be measuring bad behavior without enforcing recovery. | Review enforcement mode and repair thresholds. |
...
- Wash retrieval accounted spend/net gain: `0.5300` / `39.7500`
- Storage escrow locked/earned/refunded/outstanding: `921.6000` / `768.0000` / `153.6000` / `0.0000`
- Storage fee provider payout/burned: `768.0000` / `0.0000`
- Final open/closed/expired deals: `8` / `4` / `0`
- Data-loss events: `0`
