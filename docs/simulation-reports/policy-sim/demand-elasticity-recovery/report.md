...
| Wash accounted spend / net gain | `1.0000` / `120.1244` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
| Deals open/closed/expired | `136` / `0` / `0` | Confirms close/refund/expiry semantics remove deals from active responsibility instead of continuing to accrue rewards. |
...
| Active / exited / reserve provider capacity | `5120` / `0` / `0` slots | Measures supply remaining, removed, and still waiting outside normal placement. |
...
Wash-retrieval accounting shows explicit spend `1.0000` against possible colluding-provider gain `120.1244`.
