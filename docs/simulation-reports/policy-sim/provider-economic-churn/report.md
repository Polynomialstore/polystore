...
| Owner-funded attempts / owner escrow debit | `1200` / `0.0000` | Detects whether public demand is unexpectedly draining the deal owner's escrow. |
| Wash accounted spend / net gain | `1.2000` / `103.6462` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
Wash-retrieval accounting shows explicit spend `1.2000` against possible colluding-provider gain `103.6462`.
