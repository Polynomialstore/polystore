# Graduation Assessment: Provider Economic Churn
...
Graduation means bounded economic exits create visible capacity and repair pressure without violating durability.
