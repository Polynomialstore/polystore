...
Observed result: retrieval success was `100.00%`, reward coverage was `99.58%`, repairs started/completed were `6` / `6`, and `1` providers ended with negative modeled P&L. The run recorded `0` unavailable reads, `0` modeled data-loss events, `0` bandwidth saturation responses and `0` repair backoffs.
...
|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 100.00% | 6 | 0 | 0 | 0.1200 | 5.8000 | 6 quota misses |
| 2 | 100.00% | 6 | 6 | 0 | 0.1200 | 11.6000 | 6 quota misses |
| 3 | 100.00% | 0 | 0 | 0 | 0.0000 | 17.4000 | 6 slots repairing |
| 4 | 100.00% | 0 | 0 | 6 | 0.0000 | 23.2000 | 6 slots repairing |
| 5 | 100.00% | 0 | 0 | 0 | 0.0000 | 29.1200 | steady state |
| 6 | 100.00% | 0 | 0 | 0 | 0.0000 | 35.0400 | steady state |
| 7 | 100.00% | 0 | 0 | 0 | 0.0000 | 40.9600 | steady state |
| 8 | 100.00% | 0 | 0 | 0 | 0.0000 | 46.8800 | steady state |
| 9 | 100.00% | 0 | 0 | 0 | 0.0000 | 52.8000 | steady state |
| 10 | 100.00% | 0 | 0 | 0 | 0.0000 | 58.7200 | steady state |

## Enforcement Interpretation

The simulator recorded `12` evidence events and `12` repair ledger events. The first evidence epoch was `1` and the first repair-start epoch was `2`.
...
|---:|---|---:|---:|---|---|---|
| 2 | `repair_started` | 1 | 0 | `sp-000` | `sp-022` | `quota_shortfall` |
| 2 | `repair_started` | 5 | 0 | `sp-000` | `sp-025` | `quota_shortfall` |
| 2 | `repair_started` | 9 | 0 | `sp-000` | `sp-041` | `quota_shortfall` |
| 2 | `repair_started` | 13 | 0 | `sp-000` | `sp-045` | `quota_shortfall` |
| 2 | `repair_started` | 17 | 0 | `sp-000` | `sp-014` | `quota_shortfall` |
| 2 | `repair_started` | 21 | 0 | `sp-000` | `sp-038` | `quota_shortfall` |
| 4 | `repair_completed` | 1 | 0 | `sp-000` | `sp-022` | `catchup_complete` |
| 4 | `repair_completed` | 5 | 0 | `sp-000` | `sp-025` | `catchup_complete` |
| 4 | `repair_completed` | 9 | 0 | `sp-000` | `sp-041` | `catchup_complete` |
| 4 | `repair_completed` | 13 | 0 | `sp-000` | `sp-045` | `catchup_complete` |
| 4 | `repair_completed` | 17 | 0 | `sp-000` | `sp-014` | `catchup_complete` |
| 4 | `repair_completed` | 21 | 0 | `sp-000` | `sp-038` | `catchup_complete` |
