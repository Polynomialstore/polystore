...
Observed result: retrieval success was `100.00%`, reward coverage was `99.58%`, repairs started/ready/completed were `6` / `6` / `6`, and `1` providers ended with negative modeled P&L. The run recorded `0` unavailable reads, `0` modeled data-loss events, `0` bandwidth saturation responses and `0` repair backoffs.
...
|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 100.00% | 6 | 0 | 0 | 0 | 0.1200 | 5.8000 | 6 quota misses |
| 2 | 100.00% | 6 | 6 | 0 | 0 | 0.1200 | 5.8000 | 6 quota misses |
...
| 4 | `repair_ready` | 1 | 0 | `sp-000` | `sp-022` | `catchup_ready` |
| 4 | `repair_completed` | 1 | 0 | `sp-000` | `sp-022` | `catchup_complete` |
| 4 | `repair_ready` | 5 | 0 | `sp-000` | `sp-025` | `catchup_ready` |
| 4 | `repair_completed` | 5 | 0 | `sp-000` | `sp-025` | `catchup_complete` |
| 4 | `repair_ready` | 9 | 0 | `sp-000` | `sp-041` | `catchup_ready` |
