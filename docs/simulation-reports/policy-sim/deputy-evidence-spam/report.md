...
The policy layer recorded `240` evidence events: `0` soft, `0` threshold, `0` hard, `0` economic, `0` market, and `240` spam events. Soft and economic evidence are suitable for repair and reward exclusion; hard or convicted threshold evidence is the category that can later justify slashing or stronger sanctions.
