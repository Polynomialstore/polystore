...
| Owner-funded attempts / owner escrow debit | `480` / `0.0000` | Detects whether public demand is unexpectedly draining the deal owner's escrow. |
| Wash accounted spend / net gain | `0.4800` / `36.0000` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
| Retrieval latent/effective attempts | `480` / `480` | Shows how much retrieval load was added by demand-shock multipliers. |
...
Wash-retrieval accounting shows explicit spend `0.4800` against possible colluding-provider gain `36.0000`.
