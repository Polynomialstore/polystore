...
|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 100.00% | 28 | 6 | 0 | 0.1200 | 5.8000 | 16 withheld, 6 quota misses |
| 2 | 100.00% | 0 | 0 | 0 | 0.0000 | 11.6000 | 6 slots repairing |
| 3 | 100.00% | 0 | 0 | 6 | 0.0000 | 17.4000 | 6 slots repairing |
| 4 | 100.00% | 0 | 0 | 0 | 0.0000 | 23.3200 | steady state |
...
The simulator recorded `12` evidence events and `12` repair ledger events. The first evidence epoch was `1` and the first repair-start epoch was `1`.
...
| 3 | `repair_completed` | 13 | 0 | `sp-000` | `sp-022` | `catchup_complete` |
| 3 | `repair_completed` | 17 | 0 | `sp-000` | `sp-028` | `catchup_complete` |
| 3 | `repair_completed` | 21 | 0 | `sp-000` | `sp-016` | `catchup_complete` |
