# Risk Register: Operator Concentration Cap
...
- Wash retrieval accounted spend/net gain: `1.9200` / `173.1840`
...
- Final open/closed/expired deals: `40` / `0` / `0`
- Data-loss events: `0`
- Saturated responses: `0`
- Performance Fail-tier serves: `0`
- Performance reward paid: `0.0000`
- Top operator provider share: `50.00%`
- Top operator assignment share: `12.08%`
