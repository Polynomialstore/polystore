...
| Owner-funded attempts / owner escrow debit | `1540` / `0.0000` | Detects whether public demand is unexpectedly draining the deal owner's escrow. |
| Wash accounted spend / net gain | `1.5400` / `136.5584` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
Wash-retrieval accounting shows explicit spend `1.5400` against possible colluding-provider gain `136.5584`.
