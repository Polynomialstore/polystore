# Graduation Assessment: Provider Supply Entry
...
Graduation means reserve-provider onboarding and probationary promotion are explicit enough to tune replacement supply before keeper lifecycle state is implemented.
