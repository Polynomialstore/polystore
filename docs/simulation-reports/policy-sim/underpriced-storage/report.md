...
| Wash accounted spend / net gain | `0.3200` / `4.5440` | Worst-case colluding requester/provider economics after explicit base, sponsor, and owner-funded variable spend. |
...
| Churn pressure provider-epochs / peak | `384` / `48` | Shows the breadth and duration of providers below the configured churn threshold. |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `op-000` | 1 | 2.08% | 6 | 2.08% | 59 | 100.00% | -13.7069 |
| `op-001` | 1 | 2.08% | 6 | 2.08% | 50 | 100.00% | -13.7150 |
| `op-002` | 1 | 2.08% | 6 | 2.08% | 60 | 100.00% | -13.7060 |
| `op-003` | 1 | 2.08% | 6 | 2.08% | 65 | 100.00% | -13.7015 |
| `op-004` | 1 | 2.08% | 6 | 2.08% | 56 | 100.00% | -13.7096 |
| `op-005` | 1 | 2.08% | 6 | 2.08% | 65 | 100.00% | -13.7015 |
| `op-006` | 1 | 2.08% | 6 | 2.08% | 63 | 100.00% | -13.7033 |
| `op-007` | 1 | 2.08% | 6 | 2.08% | 63 | 100.00% | -13.7033 |
...
Wash-retrieval accounting shows explicit spend `0.3200` against possible colluding-provider gain `4.5440`.
