# Risk Register: Storage Escrow Noncompliance Burn
...
|---|---|---|---|---|
| Storage fees withheld from providers | `medium` | 9.6000 earned storage-fee units were burned instead of paid. | This is expected for non-compliant responsibility, but unexpected burns in a healthy escrow fixture indicate accounting or reward-eligibility drift. | Review storage-fee eligibility, quota thresholds, and whether storage fees should follow base reward exclusion semantics. |
...
- Audit budget demand: `0.0300`
- Audit budget spent: `0.0300`
