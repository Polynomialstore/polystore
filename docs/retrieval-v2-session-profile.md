...
160000000 profile was selected after the fixed aggregate V3 workload sustained
12 gas-limited blocks at round zero with all four validator signatures. Issue
#328 owns the separate default-off parallel-execution feasibility spike.
