      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] transition-all duration-300">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center gap-4 relative z-10">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
              ...
              <Link 
                to="/dashboard"
                className="hidden sm:flex items-center gap-3 px-6 py-3 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-[0.2em] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.12)] dark:shadow-[0_0_24px_hsl(var(--primary)_/_0.22)] hover:translate-x-[-1px] hover:translate-y-[-1px] active:translate-x-[2px] active:translate-y-[2px] transition-all"
              >
            ...
            >
              ...
              <div className="flex flex-col p-6 space-y-6">
                ...
                <Link 
                    ...
                    className="block w-full py-4 bg-primary text-primary-foreground font-bold text-center text-[11px] uppercase tracking-[0.2em] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.12)] dark:shadow-[0_0_24px_hsl(var(--primary)_/_0.22)] active:translate-x-[2px] active:translate-y-[2px] transition-transform flex items-center justify-center gap-3"
                  >
