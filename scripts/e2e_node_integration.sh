...
export POLYSTORE_START_FAUCET="${POLYSTORE_START_FAUCET:-0}"
export POLYSTORE_START_WEB="${POLYSTORE_START_WEB:-0}"
export POLYSTORE_GATEWAY_BASE="$GATEWAY_BASE"
export POLYSTORE_LCD_BASE="$LCD_BASE"
export POLYSTORE_FAUCET_BASE="$FAUCET_BASE"
export POLYSTORE_E2E_PRIVKEY="${POLYSTORE_E2E_PRIVKEY:-${POLYSTORE_EVM_DEV_PRIVKEY:-0xa6694e2fb21957d26c442f80f14954fd84f491a79a7e5f1133495403c0244c1d}}"
export POLYSTORE_AUTO_FAUCET_EVM="${POLYSTORE_AUTO_FAUCET_EVM:-1}"
...
start_custom_faucet() {
  ...
  (
    ...
    nohup env \
      ...
      POLYSTORE_DENOM="${POLYSTORE_DENOM:-stake}" \
      POLYSTORE_AMOUNT="${POLYSTORE_AMOUNT:-1000000000000000000aatom,100000000stake}" \
      POLYSTORE_GAS_PRICES="${POLYSTORE_GAS_PRICES:-0.001aatom}" \
      POLYSTORE_LISTEN_ADDR="${FAUCET_BASE#http://}" \
      go run . \
