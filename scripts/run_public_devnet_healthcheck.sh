...
required=(
  ...
  POLYSTORE_EXPECTED_EVM_DENOM POLYSTORE_EXPECTED_CONSENSUS_MAX_GAS
  POLYSTORE_EXPECTED_CONSENSUS_MAX_BYTES
...
args=(
  ...
  --expected-consensus-max-gas "$POLYSTORE_EXPECTED_CONSENSUS_MAX_GAS"
  --expected-consensus-max-bytes "$POLYSTORE_EXPECTED_CONSENSUS_MAX_BYTES"
