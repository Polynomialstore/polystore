...
FAUCET_BASE_DEFAULT="${POLYSTORE_TESTNET_FAUCET_URL:-}"
FAUCET_BASE_DEFAULT="${FAUCET_BASE_DEFAULT%/faucet}"
...
echo "  VITE_FAUCET_AUTH_TOKEN=(runtime only; not embedded by this script)"
