...
*   **`POST /sp/receipt`**
    ...
    *   **Logic:**
        ...
        5.  **Devnet Shortcut:** Immediately submit `MsgProveLiveness` via `polystorechaind`.
...
*   **Steps:**
    ...
    7.  **Verify:** Check `polystorechain` for `MsgProveLiveness` event and Deal Heat increment.
