...
*   **`polystore_core` (FFI):** PolyFS layout helpers (MDU #0 builder, record parsing) and cryptographic helpers shared with Rust.
...
- **Key semantics:** the object key maps to a PolyFS `file_path` inside that deal.
