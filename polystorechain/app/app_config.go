...
import (
	_ "polystorechain/x/polystorechain/module"
	polystorechainmoduletypes "polystorechain/x/polystorechain/types"
	"time"
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						// chain modules
						polystorechainmoduletypes.ModuleName,
			...
			{
				Name:   polystorechainmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&polystorechainmoduletypes.Module{}),
			},
