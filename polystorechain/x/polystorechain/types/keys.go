...
var (
	...
	ProviderStorageRewardsKey            = collections.NewPrefix("ProviderStorageRewards/value/")
	ProviderBandwidthRewardsKey          = collections.NewPrefix("ProviderBandwidthRewards/value/")
	...
	RetrievalSessionsV3Key               = collections.NewPrefix("RetrievalSessionsV3/value/")
	RetrievalSessionV3TerminalAnchorsKey = collections.NewPrefix("RetrievalSessionV3TerminalAnchors/value/")
	RetrievalSessionV3NonceKey           = collections.NewPrefix("RetrievalSessionV3Nonce/value/")
	RetrievalSessionV3NonceIDKey         = collections.NewPrefix("RetrievalSessionV3NonceID/value/")
	...
	RetrievalV2ActivatedHeightKey        = collections.NewPrefix("RetrievalV2ActivatedHeight/value/")
	RetrievalV3ActivatedHeightKey        = collections.NewPrefix("RetrievalV3ActivatedHeight/value/")
	PendingDealGenerationsV3Key          = collections.NewPrefix("PendingDealGenerationsV3/value/")
	AdmittedDealGenerationsV3Key         = collections.NewPrefix("AdmittedDealGenerationsV3/value/")
	ChallengeAnchorsKey                  = collections.NewPrefix("ChallengeAnchors/value/")
	ChallengePendingAnchorsKey           = collections.NewPrefix("ChallengePendingAnchors/value/")
	RetrievalSessionExpiryRefsKey        = collections.NewPrefix("RetrievalSessionExpiryRefs/value/")
	RetrievalSessionExpiryCountsKey      = collections.NewPrefix("RetrievalSessionExpiryCounts/value/")
	RetrievalSessionOpenCountsKey        = collections.NewPrefix("RetrievalSessionOpenCounts/value/")
	RetrievalSessionLiveCountKey         = collections.NewPrefix("RetrievalSessionLiveCount/value/")
	RetrievalSessionGenerationRefsKey    = collections.NewPrefix("RetrievalSessionGenerationRefs/value/")
	RetrievalSessionGenerationCountsKey  = collections.NewPrefix("RetrievalSessionGenerationCounts/value/")
	RetrievalSessionGenerationCountKey   = collections.NewPrefix("RetrievalSessionGenerationCount/value/")
	...
	RepairAttemptStatesKey               = collections.NewPrefix("RepairAttemptStates/value/")
	AssignmentCollateralLocksKey         = collections.NewPrefix("AssignmentCollateralLocks/value/")
	AssignmentCollateralLocksByDealKey   = collections.NewPrefix("AssignmentCollateralLocksByDeal/value/")
	ProviderBondUnbondingCountKey        = collections.NewPrefix("ProviderBondUnbondingCount/value/")
	ProviderBondUnbondingsKey            = collections.NewPrefix("ProviderBondUnbondings/value/")
	ProviderBondUnbondingsByProviderKey  = collections.NewPrefix("ProviderBondUnbondingsByProvider/value/")
	...
	Mode2RepairReadinessProofsKey = collections.NewPrefix("Mode2RepairReadinessProofs/value/")
