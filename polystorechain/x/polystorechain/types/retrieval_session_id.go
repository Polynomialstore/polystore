...
//
//	owner(20) || deal_id(8) || provider(20) || polyfs_root(32) ||
...
func HashRetrievalSessionID(
	...
	if len(polyfsRoot32) != POLYFS_ROOT_SIZE {
		return nil, errors.New("manifest_root must be 32 bytes")
	}
