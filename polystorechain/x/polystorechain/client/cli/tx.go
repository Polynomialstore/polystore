...
func GetTxCmd() *cobra.Command {
	...
	cmd.AddCommand(CmdRetrievalSessionV3())
	...
	cmd.AddCommand(CmdBindProviderStake())
	cmd.AddCommand(CmdUnbindProviderStake())
	...
	cmd.AddCommand(CmdProposeDealGenerationV3())
	cmd.AddCommand(CmdAcceptDealGenerationV3())
	cmd.AddCommand(CmdFinalizeDealGenerationV3())
