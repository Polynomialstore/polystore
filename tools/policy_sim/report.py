    ...
    lines.extend(
        [
            ...
            *evidence_excerpt_lines(evidence),
            ...
            "## Generated Graphs",
            "",
            "- `graphs/retrieval_success_rate.svg`: should stay near 1.0 unless availability is actually lost.",
            "- `graphs/slot_states.svg`: shows active slots and repair slots; spikes indicate reassignment churn.",
            "- `graphs/provider_pnl.svg`: shows aggregate provider economics over time.",
            "- `graphs/burn_mint_ratio.svg`: shows whether burns are material relative to minted rewards and audit budget.",
            "",
            "## Raw Artifacts",
            "",
