...
HOME_DIR="$ROOT_DIR/polystorechain/.polystorechain/open_session_mode2"
...
CREATE_RES=$(run_yes "$BINARY" tx polystorechain create-deal 50 1000000 5000 --service-hint "$SERVICE_HINT" \
