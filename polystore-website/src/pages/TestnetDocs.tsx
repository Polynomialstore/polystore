      ...
      <div className="grid gap-12">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold border-b pb-2 text-foreground flex items-center gap-2">
            <Download className="w-6 h-6 text-primary" /> Quick Start
          </h2>
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-none border border-border/60 bg-secondary/10 p-4 text-sm text-muted-foreground">
            ...
            <div className="mt-1">
              Install <code className="px-1 py-0.5 rounded-none bg-secondary/60">polystore_gateway_gui</code>, start it, then refresh this page.
            ...
            >
              Download PolyStore Gateway GUI (`nil_gateway_gui`)
            </a>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="glass-panel industrial-border p-6">
            <h3 className="font-bold text-lg text-foreground mb-4">Network Settings</h3>
            <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                    ...
                    <span className="font-mono-data text-foreground">{appConfig.evmRpc}</span>
                </div>
                <div>
                    <span className="text-muted-foreground block">Chain ID</span>
                    <span className="font-mono-data text-foreground">{appConfig.chainId}</span>
                </div>
                <div>
                    <span className="text-muted-foreground block">Currency Symbol</span>
                    <span className="font-mono-data text-foreground">NIL</span>
                </div>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold border-b pb-2 text-foreground flex items-center gap-2">
            <Wallet className="w-6 h-6 text-primary" /> Wallet & Faucet
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
