...
export type RetrievalDiagnostic = { phase: string; atMs: number; edge?: 'start' | 'end'; sessionId?: string; chunkId?: string; slot?: number; offset?: number; bytes?: number; sessionIds?: readonly string[]; height?: string }
