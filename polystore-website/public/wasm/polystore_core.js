...
const PolyStoreWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_polystorewasm_free(ptr >>> 0, 1));
...
export class PolyStoreWasm {
     ...
     * @returns {Uint8Array}
     */
    static reconstruct_mdu_from_shards(input, k, m) {
        const ret = wasm.polystorewasm_reconstruct_mdu_from_shards(input, k, m);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    commit_blobs(blobs_flat) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.polystorewasm_commit_blobs(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    compute_manifest(roots_flat) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.polystorewasm_compute_manifest(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    compute_mdu_root(witness_flat) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.polystorewasm_compute_mdu_root(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    set_wasm_msm_basis_mode(mode) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.polystorewasm_set_wasm_msm_basis_mode(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class WasmMdu0Builder {
     ...
     * @returns {WasmMdu0Builder}
     */
    static load_legacy_recovery(data, max_user_mdus, commitments_per_mdu) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmdu0builder_load_legacy_recovery(ptr0, len0, max_user_mdus, commitments_per_mdu);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmMdu0Builder.__wrap(ret[0]);
     ...
     * @returns {WasmMdu0Builder}
     */
    static stage_v2_from_trusted_legacy(data, max_user_mdus, commitments_per_mdu) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmmdu0builder_stage_v2_from_trusted_legacy(ptr0, len0, max_user_mdus, commitments_per_mdu);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmMdu0Builder.__wrap(ret[0]);
    ...
    append_file(path, size, start_offset) {
        const ret = wasm.wasmmdu0builder_append_file(this.__wbg_ptr, path, size, start_offset);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    append_file_with_flags(path, size, start_offset, flags) {
        const ret = wasm.wasmmdu0builder_append_file_with_flags(this.__wbg_ptr, path, size, start_offset, flags);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    get_record_count() {
        const ret = wasm.wasmmdu0builder_get_record_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
     */
    is_legacy_recovery() {
        const ret = wasm.wasmmdu0builder_is_legacy_recovery(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} index
     ...
     */
    get_record(index) {
        const ret = wasm.wasmmdu0builder_get_record(this.__wbg_ptr, index);
        if (ret[3]) {
     ...
     * @returns {Uint8Array}
     */
    read_fat_range(offset, len) {
        const ret = wasm.wasmmdu0builder_read_fat_range(this.__wbg_ptr, offset, len);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     */
    get_root(index) {
        const ret = wasm.wasmmdu0builder_get_root(this.__wbg_ptr, index);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('polystore_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
