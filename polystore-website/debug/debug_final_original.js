...
const message = {
  ...
  duration: 100n,
  service_hint: 'General', // ORIGINAL HINT
...
console.log('Digest Unsorted (Original Hint):', digestUnsorted)
...
console.log('Digest Sorted (Original Hint):  ', digestSorted)
...
async function verify() {
    ...
    if (recSorted.toLowerCase() === expected) console.log("CONCLUSION: MetaMask IS sorting + Signing Original Hint")
    else if (recUnsorted.toLowerCase() === expected) console.log("CONCLUSION: MetaMask is NOT sorting + Signing Original Hint")
}
