...
- The future “gateway GUI” is an **interface/distribution change** for the optional local gateway, not a shift of signing responsibilities away from the browser.
...
- **Run E2E Test:** `cd polystore-website && npx playwright test tests/direct-upload.spec.ts`.
