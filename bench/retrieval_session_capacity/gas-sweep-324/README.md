...
The 128M recommendation was superseded by the [failed 128M qualification](../qualification-128m-326/). That separate-transaction result remains historical evidence. The [current 192M post-batch operational profile](../../../scripts/retrieval_consensus_profile.json) depends on the same-provider batching work in [PR #331](https://github.com/Polynomialstore/polystore/pull/331).
