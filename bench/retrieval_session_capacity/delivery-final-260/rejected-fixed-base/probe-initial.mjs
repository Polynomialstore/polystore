...
for(let i=0;i<4;i++){const a=run(false),b=run(true);if(!a.result.equals(b.result))throw Error('nonconstant parity');if(i)pairs.push({baselineMs:a.ms,fixedMs:b.ms});}
