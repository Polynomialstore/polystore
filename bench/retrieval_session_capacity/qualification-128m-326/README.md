...
The sessions/day and logical GiB/day figures extrapolate a 53-second chain-only proof-confirmation interval. They are not 24-hour sustained, file-transfer, proof-preparation, signing, ACK, settlement, expiry, or refund results.
