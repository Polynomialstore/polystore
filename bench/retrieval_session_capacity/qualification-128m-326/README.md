...
This separate-transaction result remains historical evidence and does not evaluate the later same-provider batching work. The [current 192M post-batch operational profile](../../../scripts/retrieval_consensus_profile.json) depends on [PR #331](https://github.com/Polynomialstore/polystore/pull/331).
